...
using Lykke.Job.CodeReviewTgBot.Modules;
using Lykke.Logs;
...
namespace Lykke.Job.CodeReviewTgBot
{
    [PublicAPI]
    public class Startup
    {
        private const string ApiVersion = "v1";
        private const string ApiName = "CodeReviewTgBot API";
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            try
            {
                ...
                services.AddLykkeLogging(
                    settingsManager.ConnectionString(s => s.CodeReviewTgBotJob.Db.LogsConnString),
                    "CodeReviewTgBotLog",
